...
export default function InventoryModal({ isOpen, onClose }: InventoryModalProps) {
  ...
  // ERROR FIX: We do NOT pass userId here anymore. The hook handles it.
          ...
          {items.length === 0 ? (
            ...
            <div className="grid grid-cols-1 gap-2">
              {items.map((entry) => (
                ...
                >
                  {/* Icon */}
                  <div className={`w-12 h-12 rounded flex items-center justify-center mr-4 border ${
                    entry.is_equipped 
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {/* Stats Display (The code you were trying to write!) */}
                  ...
                  <button
                    ...
                    className={`ml-3 text-xs px-4 py-2 rounded font-bold transition-all min-w-[80px] ${
                      entry.is_equipped
